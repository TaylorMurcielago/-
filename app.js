...
App({
  onLaunch: function () {
    ...
    wx.request({
      url: that.globalData.baseApiUrl + '/categories',
      success: function (res) {
  ...
  getGoods: function (categoryId) {
    ...
    var that = this;
    wx.request({
      url: that.globalData.baseApiUrl + '/goodslist',
      data: {
  ...
  globalData:{
    ...
    baseApiUrl:'https://www.lcpww.cn/api',
    baseImagesUrl:'https://www.lcpww.cn/',
    globalBGColor: '#F87266',
